...
| Google Drive, `MyDrive/unlearning_data/` | чекпоинты, результаты атак, логи, лабораторный журнал | уникальное, не должно пропасть при отключении Colab |
...
- Блокнот выполняется сверху вниз. Шаги 1–4 (Drive, папки, переменные окружения, токен Hugging Face) повторяются в начале каждого блокнота: машина Colab каждый раз новая.
